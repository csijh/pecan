// Example program with generated parser. Public domain.
#include <stdio.h>
#include <stdbool.h>
#include <stdlib.h>
#include <string.h>
...
// char for a scanner or text-based parser, otherwise it should be a token
// structure or token pointer.
struct parser;
...
// this pecan tag are the patterns to be used to generate the functions.
// <pecan
//   comment  = "// %s"
