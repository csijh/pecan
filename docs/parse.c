...
// Token tags.
enum tag { number, plus, minus, times, over, open, close, bad, end };

// Node types.
enum type { Number, Add, Subtract, Multiply, Divide, Bracket };
...
// Node structure for storing parse tree nodes.
struct node { };
